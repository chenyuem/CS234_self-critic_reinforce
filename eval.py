...
loss, split_predictions, lang_stats = eval_utils.eval_split(model, crit, loader, {'split': 'test', 'dataset':'data/cocotalk.json', 'beam_size':3})
...
if opt.dump_json == 1:
    ...
    json.dump(split_predictions, open('vis/vis-'+ (opt.infos_path).split('/')[-1] + st + '.json', 'w'))
